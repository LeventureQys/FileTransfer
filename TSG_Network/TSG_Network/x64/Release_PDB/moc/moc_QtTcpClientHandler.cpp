...
#include <memory>
#include "../../../SouthQtNetwork/Api/QtTcpClientHandler.h"
...
QT_MOC_LITERAL(8, 92, 15), // "ConnectedServer"
QT_MOC_LITERAL(9, 108, 18), // "DisConnectedServer"
QT_MOC_LITERAL(10, 127, 7) // "RecvMsg"

    },
    "QtTcpClientHandler\0Sig_Connected\0\0"
    "qsServerAddr\0nServerPort\0Sig_Disconnect\0"
    "Sig_RecvTCP\0bytes\0ConnectedServer\0"
...
void QtTcpClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtTcpClientHandler::Sig_Connected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QtTcpClientHandler::*)(const QString & , const quint16 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtTcpClientHandler::Sig_Disconnect)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QtTcpClientHandler::Sig_RecvTCP)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QtTcpClientHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_QtTcpClientHandler.data,
    qt_meta_data_QtTcpClientHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
